...
const VaultListItem = ({ farm, ...rest }) => {
  ...
  function getTvl() {
    ...
    if(farm.lpToken == '0xc946DAf81b08146B1C7A8Da2A851Ddf2B3EAaf85' || farm.lpToken == "0x382bB369d343125BfB2117af9c149795C6C65C50"){
      return Number(farm.totalLp / 10 ** decimals);
    }
          ...
          <div className="mb-4">
            <Disclosure.Button
              className={classNames(
                open && 'rounded-b-none',
                'w-full px-4 py-6 text-left rounded cursor-pointer select-none mybg700  text-primary text-sm md:text-lg'
              )}
            >
