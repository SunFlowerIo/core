...
export const SDN: { [key: string]: Token } = {
  USDC: new Token(ChainId.SDN, '0xc946DAf81b08146B1C7A8Da2A851Ddf2B3EAaf85', 18, 'USDC', 'USD Coin'),
  USDT: new Token(ChainId.SDN, '0x4ECaBa5870353805a9F068101A40E0f32ed605C6', 6, 'USDT', 'Tether USD'),
  WBTC: new Token(ChainId.SDN, '0x8e5bBbb09Ed1ebdE8674Cda39A0c169401db4252', 8, 'WBTC', 'Wrapped Bitcoin'),
  WETH: new Token(ChainId.SDN, '0x6A023CCd1ff6F2045C3309768eAd9E68F978f6e1', 18, 'WETH', 'Wrapped Ether'),
}
...
export const SOLAR: ChainTokenMap = {
  [ChainId.SDN]: new Token(ChainId.SDN, SOLAR_ADDRESS[ChainId.SDN], 18, 'SUNF', 'SUNF'),
}

export const WETH9_EXTENDED: { [chainId: number]: Token } = {
  ...WETH9,
  [SupportedChainId.SDN]: new Token(ChainId.SDN, '0x05Bcebb9b5b914aD52Ed87801904AfCe359e694F', 18, 'WSDN', 'WSDN'),
}
