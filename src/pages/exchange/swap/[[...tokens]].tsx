...
export default function Swap() {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`SunFlowerSwap`)}</title>
        <meta
          key="description"
          name="description"
          content="SunFlowerSwap allows for swapping of compatible tokens on Shiden."
        />
      </Head>
      ...
      <DoubleGlowShadow opacity="0.6">
        <div id="swap-page" className="w-full max-w-2xl p-4 space-y-4 rounded mybgdark z-1">
          <SwapHeader
          ...
          <div>
            ...
            <AutoColumn justify="space-between" className="py-3">
              <AutoRow justify={isExpertMode ? 'space-between' : 'flex-start'} style={{ padding: '0 1rem' }}>
                ...
                >
                  <div className="rounded-full mybgdark p-3px">
                    <div
                      className="p-3 rounded-full mybgdark hover:mybgdark"
            ...
            <div>
              ...
              />
              {Boolean(trade) && (
                <div className="p-1 -mt-2  rounded-b-md mybgdark">
                  <TradePrice
