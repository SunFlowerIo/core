...
export default function Pool() {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Pool`)} | SunFlower</title>
        <meta
          key="description"
          name="description"
          content="SunFlower liquidity pools are markets for trades between the two tokens, you can provide these tokens and become a liquidity provider to earn 0.25% of fees from trades."
        />
      </Head>
      <CurrencyLogoWithTitle/>
      <DoubleGlowShadow opacity="0.6">
        <Container maxWidth="2xl" className="space-y-6">
          <div className="p-4 space-y-4 rounded mybgdark">
