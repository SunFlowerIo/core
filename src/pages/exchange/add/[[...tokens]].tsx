...
export default function Add() {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Add Liquidity`)} | SunFlower</title>
        <meta
          key="description"
          name="description"
          content="Add liquidity to the SunFlower AMM to enable gas optimised and low slippage trades across countless networks"
        />
      </Head>
      <SolarbeamLogo />
      <Container id="remove-liquidity-page" maxWidth="2xl" className="space-y-4">
        <DoubleGlowShadow>
          <div className="p-4 space-y-4 rounded mybg900" style={{ zIndex: 1 }}>
            <ExchangeHeader
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div>
                ...
                <AutoColumn justify="space-between" className="py-2.5">
                  <AutoRow justify={isExpertMode ? 'space-between' : 'flex-start'} style={{ padding: '0 1rem' }}>
                    <button className="z-10 -mt-6 -mb-6 rounded-full cursor-default mybg900 p-3px">
                      <div className="p-3 rounded-full mybg800">
                        <Plus size="32" />
                      </div>
                    </button>
                  </AutoRow>
              ...
              {currencies[Field.CURRENCY_A] && currencies[Field.CURRENCY_B] && pairState !== PairState.INVALID && (
                <div className="p-1 rounded mybg800">
                  <LiquidityPrice
                    currencies={currencies}
                    price={price}
                    noLiquidity={noLiquidity}
