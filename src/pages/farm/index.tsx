...
export default function Farm(): JSX.Element {
  ...
  return (
    <>
      <Head>
        <title>Farm | SunfFlower</title>
        <meta key="description" name="description" content="Farm SUNF" />
      </Head>
                ...
                <div className={`grid grid-cols-12 md:space-x-4 space-y-4 md:space-y-0 `}>
                  <div className={`col-span-12 md:col-span-3 space-y-4`}>
                    ...
                    <div className={`flex flex-col items-center justify-between px-6 py-6 `}>
                      <div className="color13b flex items-center text-center justify-between py-2 text-emphasis">
                      ...
                      {positions.length > 0 && (
                        <div className="color13b flex items-center justify-between py-2 text-emphasis">
                  ...
                  <div className={`col-span-12 md:col-span-9 py-4 md:px-6 md:py-4 rounded`}>
                    <div className={'mb-8 px-1 md:px-0'}>
                      <Search
                        className={'mybg800 rounded border border-dark-800'}
