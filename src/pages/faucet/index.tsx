          ...
          <div className="p-4 space-y-4 rounded bg-dark-900" style={{ zIndex: 1 }}>
            <div className="p-4 mb-3 space-y-3 text-center">
              ...
              <Typography component="h1" variant="base">
                A Faucet is a tool that provides a small amount of MOVR for users that used the bridge to start using SunFlowerswap.io without having to
                buy SDN somewhere else.
              </Typography>
            </div>
            <div className="flex flex-1 justify-center text-center items-center mt-8 mb-12">
              <Image src="/images/faucet/moonriver-faucet.png" alt="SunFlower" width={150} height={150} />
            </div>
