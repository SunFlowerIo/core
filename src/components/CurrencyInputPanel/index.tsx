...
export default function CurrencyInputPanel({
  ...
  return (
    <div id={id} className={classNames(hideInput ? 'p-4' : 'p-5', 'rounded mybg2')}>
      <div className="flex flex-col justify-between space-y-3 sm:space-y-0 sm:flex-row">
          ...
          >
            <div className="flex">
              {pair ? (
                ...
                <div className="rounded mybgdark" style={{ maxWidth: 54, maxHeight: 54 }}>
              ...
              {pair ? (
                ...
                <div className="flex flex-1 flex-col items-start justify-center mx-3.5">
                  ...
                  <div className="flex items-center">
                    <div className="text-lg font-bold token-symbol-container md:text-2xl" style={{color:num ==1 ? "#13b5b1":''}}>
        ...
        {!hideInput && (
          <div
            className={classNames(
              'flex items-center w-full space-x-3 rounded mybgdark focus:bg-dark-700 p-3'
