...
export const getTokenLogoURL = (address: string, chainId: ChainId) => {
  ...
  return `https://sunflowerswap.io/blockchains/${BLOCKCHAIN[chainId].toLowerCase()}/assets/${address}/logo.png`
}
...
function getCurrencyLogoUrls(currency) {
  ...
  if (currency.chainId in BLOCKCHAIN) {
    urls.push(
      ...
      `https://sunflowerswap.io/blockchains/${BLOCKCHAIN[currency.chainId].toLowerCase()}/assets/${
        currency.address
      }/logo.png`
    )
  }
...
const SdnLogo = 'https://shiden.subscan.io/static/img/shiden.526f0686.png'
...
const solar = 'https://sunflowerswap.io/logo.png'
