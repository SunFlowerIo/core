              ...
              <div className="flex items-center justify-between">
                  ...
                  <div className="hidden sm:block sm:ml-4">
                    <div className="flex space-x-2">
                      <NavLink href="/exchange/swap">
                        <a
                          id={`swap-nav-link`}
                          className="p-2 text-base text-primary colorfff hover:text-high-emphesis focus:text-high-emphesis whitespace-nowrap"
                        >
                          {i18n._(t`Swap`)}
                        </a>
                      </NavLink>
                ...
                <div className="fixed bottom-0 left-0 z-10 flex flex-row items-center justify-center w-full p-4 lg:w-auto bg-dark-1000 lg:relative lg:p-0 lg:bg-transparent">
                  <div className="flex items-center justify-between w-full space-x-2 sm:justify-end">
                    {chainId && [ChainId.SDN].includes(chainId) && (
                ...
                <div className="flex flex-1 -mr-2 sm:hidden">
                  <div className="flex-1">
                    <Image src="/icon.png" alt="SunFlower" height="40px" width="40px" className="sm:hidden" />
                  </div>
                  <LanguageSwitch />
