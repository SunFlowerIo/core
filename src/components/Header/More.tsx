...
const items = (i18n: I18n) => [
  {
    ...
    href: 'https://t.me/Sunflowerswap_official',
    external: true,
  },
  {
    name: i18n._(t`Twitter`),
    description: i18n._(t`Follow us on Twitter`),
    href: 'https://twitter.com/SunflowerSwap',
    external: true,
  },
]
      ...
      {({ open }) => (
        <>
          ...
          >
            <Popover.Panel
              static
              className="absolute z-50 w-screen max-w-md px-2 mt-3 transform -translate-x-full bottom-12 lg:top-12 left-full sm:px-0"
            >
                  ...
                  {solutions.map((item) =>
                    item.external ? (
                      ...
                      >
                        ...
                        <p className="mt-1 text-sm text-secondary" style={{color:"#fff"}}>{item.description}</p>
                      </ExternalLink>
                    ) : (
