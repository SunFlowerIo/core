  ...
  return (
    <>
      {userPoolBalance && JSBI.greaterThan(userPoolBalance.quotient, JSBI.BigInt(0)) ? (
        <div className="p-5 rounded mybg2 text-high-emphesis">
          <AutoColumn gap={'md'}>
...
export default function FullPositionCard({ pair, border, stakedBalance }: PositionCardProps) {
  ...
  return (
    <div
      className="rounded mybg800"
      // style={{ backgroundColor }}
    >
      <Button
        variant="empty"
        className={classNames(
          'flex items-center justify-between w-full px-4 py-6 cursor-pointer mybg2 hover:mybg800',
          showMore && '!mybg800'
        )}
      ...
      >
        <div className="p-4 space-y-4">
          <div className="px-4 py-4 space-y-1 text-sm rounded text-high-emphesis mybg2">
